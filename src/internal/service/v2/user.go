...
func (s *service) clearCacheForUser(ctx context.Context, user *entities_user_v2.User) error {
...
func (s *service) CreateUser(ctx context.Context, req *entities_user_v2.CreateUserRequest) (*entities_user_v2.User, error) {
...
func (s *service) GetUserByEmail(ctx context.Context, email string) (*entities_user_v2.User, error) {
	cachedUser, err := s.cache.Get(ctx, email)
	if err == nil {
		var user *entities_user_v2.User
...
func (s *service) GetUserByID(ctx context.Context, userID string) (*entities_user_v2.User, error) {
...
func (s *service) GetUserByUsername(ctx context.Context, username string) (*entities_user_v2.User, error) {
...
func (s *service) UpdateUsername(ctx context.Context, userID, username string) (*entities_user_v2.User, error) {
